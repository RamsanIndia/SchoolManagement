...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Token", "IsRevoked")
                        .HasDatabaseName("IX_RefreshTokens_TenantId_Token_IsRevoked");

                    b.HasIndex("TenantId", "ExpiryDate", "IsRevoked", "IsDeleted")
                        .HasDatabaseName("IX_RefreshTokens_TenantId_ExpiryDate_IsRevoked_IsDeleted");

                    b.HasIndex("TenantId", "SchoolId", "UserId", "IsRevoked", "ExpiryDate")
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Employee", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Employee.Address#SchoolManagement.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Employee.BiometricInfo#SchoolManagement.Domain.ValueObjects.BiometricInfo", "BiometricInfo", b1 =>
                        {
                            b1.Property<Guid>("EmployeeId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Employee.SalaryInfo#SchoolManagement.Domain.ValueObjects.Salary", "SalaryInfo", b1 =>
                        {
                            b1.Property<Guid>("EmployeeId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Notification", b =>
                {
                    b.OwnsOne("SchoolManagement.Domain.Entities.Notification.Content#SchoolManagement.Domain.ValueObjects.NotificationContent", "Content", b1 =>
                        {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Notification.Recipient#SchoolManagement.Domain.ValueObjects.Recipient", "Recipient", b1 =>
                        {
                            b1.Property<Guid>("NotificationId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Section", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Section.Capacity#SchoolManagement.Domain.ValueObjects.SectionCapacity", "Capacity", b1 =>
                        {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Section.RoomNumber#SchoolManagement.Domain.ValueObjects.RoomNumber", "RoomNumber", b1 =>
                        {
                            b1.Property<Guid>("SectionId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Student", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Student.Address#SchoolManagement.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Student.BiometricInfo#SchoolManagement.Domain.ValueObjects.BiometricInfo", "BiometricInfo", b1 =>
                        {
                            b1.Property<Guid>("StudentId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentParent", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.StudentParent.Address#SchoolManagement.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            ...
                            b1.ToTable("StudentParents", (string)null);
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Teacher.Address#SchoolManagement.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Teacher.Email#SchoolManagement.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("TeacherId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Teacher.Name#SchoolManagement.Domain.ValueObjects.FullName", "Name", b1 =>
                        {
                            b1.Property<Guid>("TeacherId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.Teacher.PhoneNumber#SchoolManagement.Domain.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("TeacherId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.TimeTableEntry", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.TimeTableEntry.RoomNumber#SchoolManagement.Domain.ValueObjects.RoomNumber", "RoomNumber", b1 =>
                        {
                            ...
                            b1.ToTable("TimeTableEntries", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("TimeTableEntryId");
                        });

                    b.OwnsOne("SchoolManagement.Domain.Entities.TimeTableEntry.TimePeriod#SchoolManagement.Domain.ValueObjects.TimePeriod", "TimePeriod", b1 =>
                        {
                            b1.Property<Guid>("TimeTableEntryId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.OwnsOne("SchoolManagement.Domain.Entities.User.FullName#SchoolManagement.Domain.ValueObjects.FullName", "FullName", b1 =>
                        {
